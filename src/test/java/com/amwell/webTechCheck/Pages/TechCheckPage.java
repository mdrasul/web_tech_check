...
public class TechCheckPage extends BasePage{
	...
	public boolean cameraNagativeFlowTest() {
		try {		
			clickSummary.click();
			compareresult("Your computer is not ready for online visits");	
			return true;	
	...
	public boolean cameraNagativeTroubleshootFlowTest() {
		try {		
			clickNo();
			clickSummary.click();
			compareresult("Your computer is not ready for online visits");	
	...
	public boolean micNagativeFlowTest() {
		try {
			clickMiocrophone();			
			clickSummary.click();
			compareresult("Your computer is not ready for online visits");	
	...
	public boolean micNagativeTroubleshootFlowTest() {
		try {
			clickMiocrophone();
			clickNo();
			clickSummary.click();
	...
	public boolean speakerNagativeFlowTest() {
		try {
			clickSpeaker();		
			clickSummary.click();
			compareresult("Your computer is not ready for online visits");	
	...
	public boolean speakerNagativeTroubleshootFlowTest() {
		try {
			clickSpeaker();	
			clickNo();
			clickSummary.click();
