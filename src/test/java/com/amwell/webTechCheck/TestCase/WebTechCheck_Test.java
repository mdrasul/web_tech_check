...
import com.amwell.webTechCheck.Pages.CameraWidget;
import com.amwell.webTechCheck.Pages.InternetSpeedWidget;
import com.amwell.webTechCheck.Pages.MicrophoneWidget;
import com.amwell.webTechCheck.Pages.SpeakerWidget;
import com.amwell.webTechCheck.Pages.SummaryWidget;
import com.amwell.webTechCheck.Pages.TechCheckPage;
import com.amwell.webTechCheck.Pages.TroubleshootingWidget;
...
public class WebTechCheck_Test {
	 ...
	 * Given I am on Web-Teach Check page Then I Navigate to Camera Widget by answering yes to
	...
	/**
	 * Scenario : User can Check internet speed 
	...
	/**
	 * Scenario : User sees Trobleshootng tips for failed Device Check 
	 * Given I am on
	...
	/**
	 * Scenario : User sees Device Check failed status in the SummaryPage 
	 * Given I am on videoCamera
	 * Web-Teach Check page And click SamaryPage without checking other Device Check
	 * Expect to see Your computer is not ready for online visits
	 * Test Id:
	 * Id :OC-47474,OC-47437,OC-47443
	 * @see <a href="https://jira.americanwell.com/browse/OC-46250">Traobleshooting ..</a>
	 * @author MD RASUL
	 */
	@Test(enabled = true)
	public void webTectCheckCameraNagativeFlowTestw() {
		log.info("User Should See failed device Check Summary.....");
		
		Assert.assertTrue(techCheckPage.cameraNagativeFlowTest(),
				"falied to get failed Device check Report in SummaryPage ");
		
	}
	/**
	 * Scenario : User sees Device Check failed status in the SummaryPage 
	 * Given I am on Microphone
	 * Web-Teach Check page And click SamaryPage without checking other Device Check
	 * Expect to see Your computer is not ready for online visits
	 * Test Id:
	 * Id :OC-47474,OC-47437,OC-47443
	 ...
	 */
	@Test(enabled = true)
	public void webTectCheckMicNagativeFlowTest() {
		log.info("User Should navigate to Trobleshooing tips if Camera,mic etc Test failed.....");
		
		Assert.assertTrue(techCheckPage.micNagativeFlowTest(),
				"Without checking other with only vidoe is ... ");
		
	}
	
	/**
	 * Scenario : User sees Device Check failed status in the SummaryPage 
	 * Given I am on Speaker
	 * Web-Teach Check page And click SamaryPage without checking other Device Check
	 * Expect to see Your computer is not ready for online visits
	 * Test Id:
	 * Id :OC-47474,OC-47437,OC-47443
	...
	@Test(enabled = true)
	public void webTectCheckSpeakerNagativeFlowTest() {
		log.info("User Should navigate to Trobleshooing tips if Camera,mic etc Test failed.....");
		
		Assert.assertTrue(techCheckPage.speakerNagativeFlowTest(),
				"Without checking other with only vidoe is ... ");
	 ...
	 */
	@Test(enabled = true)
	public void webTectCheckCameraNagativeTroubleshootFlowTest() {
		log.info("User Should .....");
		
		Assert.assertTrue(techCheckPage.cameraNagativeTroubleshootFlowTest(),
				"Without checking other with only vidoe is ... ");
	 ...
	 */
	@Test(enabled = true)
	public void webTectCheckMicNagativeTroubleshootFlowTest() {
		log.info("User Should .....");
		
		Assert.assertTrue(techCheckPage.micNagativeTroubleshootFlowTest(),
				"Without checking other with only vidoe is ... ");
	 ...
	 */
	@Test(enabled = true)
	public void webTectCheckSpeakerNagativeTroubleshootFlowTest() {
		log.info("User Should .....");

		Assert.assertTrue(techCheckPage.speakerNagativeTroubleshootFlowTest(),
				"Without checking other with only vidoe is ... ");
